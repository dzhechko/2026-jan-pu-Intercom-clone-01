...
```
Possible duplicate of [INS-NNN] Title
...
1. Move `myinsights/INS-NNN-slug.md` to `myinsights/archive/INS-NNN-slug.md`
2. Update status in `1nsights.md` index to `Obsolete`
3. Add `(archived)` suffix to the file link in index
4. Notify: `INS-NNN archived to myinsights/archive/`
...
4. Notify: `INS-NNN status changed to [new status]`
...
3. Note: `INS-NNN hit count incremented to N (helped solve current issue)`
